...
################################################################## Dynamic Object
output=output/dynamic_object2
exp=fan
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/fan -m $output/$exp --max_time 0.72 --light --physics_code 16 --enable_pinns --pinns_mode rigid
...
exp=whale
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/whale -m $output/$exp --max_time 0.75 --light --physics_code 16
python render.py -m $output/$exp --mode render --skip_train
python metrics.py -m $output/$exp --s test --half_res
python metrics.py -m $output/$exp --s val --half_res

exp=shark
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/shark -m $output/$exp --max_time 0.75 --light --physics_code 16
python render.py -m $output/$exp --mode render --skip_train
python metrics.py -m $output/$exp --s test --half_res
python metrics.py -m $output/$exp --s val --half_res

exp=telescope
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/telescope -m $output/$exp --max_time 0.72 --light --physics_code 16
python render.py -m $output/$exp --mode render --skip_train
python metrics.py -m $output/$exp --s test --half_res
python metrics.py -m $output/$exp --s val --half_res

exp=fallingball
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/fallingball -m $output/$exp --max_time 0.72 --light --physics_code 16
python render.py -m $output/$exp --mode render --skip_train
python metrics.py -m $output/$exp --s test --half_res
python metrics.py -m $output/$exp --s val --half_res

exp=bat
python train_gui.py -s /data/lunengbo/LNB/FreeGave_new/data/DynObjects/data/bat -m $output/$exp --max_time 0.75 --light --physics_code 16
